...
class KeyNode implements Node
{
    ...
    public KeyNode(String value, int frequency)
    {
        this.value = value;
...
class UpperNode implements Node
{
    ...
    public UpperNode(Node left, Node right)
    {
        this.left = left;
        this.right = right;
    }
    ...
    public int getFrequency()
    {
        return this.getLeft().getFrequency() + this.getRight().getFrequency();
    }
